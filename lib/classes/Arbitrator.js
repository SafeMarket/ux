...
Arbitrator.prototype.setFromChainState = function setFromChainState() {
  ...
  this.approvedStores = state.approvedStores.map((address) => {
...
Arbitrator.prototype.getLocalState = function getLocalState() {
  return {
    ...
    approvedStores: this.approvedStores.map((address) => {
      return address.clone()
    })
  }
}
...
Arbitrator.prototype.approvedStores = function approvedStores() {
  this.approvedStores.push(null)
}
